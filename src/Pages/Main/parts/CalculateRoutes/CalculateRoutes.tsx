        ...
        <Row justify="center">
            <Col md={24}>
                <Radio.Group style={{ display: "flex", justifyContent: 'space-between' }} defaultValue={TRANSPORT_TYPE.CAR} buttonStyle="solid" onChange={handleChangeMovmentType}>
                    ...
                    <Radio.Button style={{ backgroundColor: '#efefef' }} disabled={true} value={TRANSPORT_TYPE.BICYCLE}><img style={{ height: '1.5rem' }} src="https://img.icons8.com/ios-filled/50/000000/bicycle.png" /></Radio.Button>
                </Radio.Group>
            </Col>
        </Row>
